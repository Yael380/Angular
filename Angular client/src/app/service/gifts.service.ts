...
export class GiftsService {
    ...
    createProducts(gift : Gift) : Observable<Gift>{
        return this.http.post('http://localhost:5148/api/gifts',gift)
    }
    updateProducts(id:number,gift : Gift) : Observable<Gift>{
        return this.http.put(`http://localhost:5148/api/gifts/${id}`,gift)
    }
    deleteProduct(id : number) : Observable<void>{
        return this.http.delete<void>(`http://localhost:5148/api/gifts/${id}`,
            {params:{id:id.toString()}});
    }
    deleteProducts(arrGift : Gift[] | null) : Observable<void>{
    ...
    //     // return Promise.resolve(this.getProductsWithOrdersData());
    // }
    closeOrder(GiftCart:any[],user:any): Observable<void>{
        return this.http.put<void>(`http://localhost:5148/api/gifts/cart`,GiftCart,{ params: user})
    }
    setRaffle(){
    ...
    uploadFile(formData: FormData): Observable<any> {
      return this.http.post(`http://localhost:5148/api/gifts/upload`, formData);
    }
};
